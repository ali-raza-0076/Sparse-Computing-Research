"""
Dense Matrix Addition Benchmark (Single-Threaded, Database I/O Workflow) - CSR Format

Database I/O Workflow:
- Phase 1: Read from secondary storage (CSV files in COO format)
- Phase 2: Convert to dense, compute in RAM (NumPy)
- Phase 3: Write to secondary storage (CSV in COO format)
...
def main():
    parser = argparse.ArgumentParser(description='Dense matrix addition using NumPy arrays')
