"""
Dense Matrix Multiplication Benchmark (Single-Threaded, Database I/O Workflow) - CSR Format
...
def main():
    parser = argparse.ArgumentParser(description='Dense matrix multiplication using NumPy arrays')
